...
uint64_t load_target = 0xb000; // user_pages
...
# error
  ...
  user_llpt[(uint64_t)pa2uva((void*)&user_pages) >> PGSHIFT] = ((uint64_t)&user_pages >> PGSHIFT << PTE_PPN_SHIFT) | PTE_V | PTE_U | PTE_R | PTE_W | PTE_A | PTE_D;
  // BSS page
  user_llpt[0x6000 >> PGSHIFT] = (0x80006000 >> PGSHIFT << PTE_PPN_SHIFT) | PTE_V | PTE_U | PTE_R | PTE_W | PTE_A | PTE_D; 
